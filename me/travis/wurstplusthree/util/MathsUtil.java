...
implements Globals {
    ...
    public static double incrementRound(double number, double increment) {
        return Math.floor(number) + (double)Math.round((number - Math.floor(number)) * (1.0 / increment)) / (1.0 / increment);
    }
    ...
    public static Vec3d extrapolatePlayerPosition(EntityPlayer player, int ticks) {
        ...
        double distance = MathsUtil.square((float)player.motionX) + MathsUtil.square((float)player.motionY) + MathsUtil.square((float)player.motionZ);
    ...
    public static Vec3d calculateLine(Vec3d x1, Vec3d x2, double distance) {
        double length = Math.sqrt(MathsUtil.square((float)(x2.x - x1.x)) + MathsUtil.square((float)(x2.y - x1.y)) + MathsUtil.square((float)(x2.z - x1.z)));
