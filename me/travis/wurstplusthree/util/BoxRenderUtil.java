...
extends Tessellator {
    ...
    public static void prepare(String mode_requested) {
        ...
        BoxRenderUtil.prepare_gl();
        BoxRenderUtil.begin(mode);
    }
    ...
    public static void release() {
        BoxRenderUtil.render();
        BoxRenderUtil.release_gl();
    }
    ...
    public static void draw_cube(BlockPos blockPos, int argb, String sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        BoxRenderUtil.draw_cube(blockPos, r, g, b, a, sides);
    }
    ...
    public static void draw_cube(float x, float y, float z, int argb, String sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        BoxRenderUtil.draw_cube(INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static void draw_cube(BlockPos blockPos, int r, int g, int b, int a, String sides) {
        BoxRenderUtil.draw_cube(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
    ...
    public static void draw_cube_line(BlockPos blockPos, int argb, String sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        BoxRenderUtil.draw_cube_line(blockPos, r, g, b, a, sides);
    }
    ...
    public static void draw_cube_line(float x, float y, float z, int argb, String sides) {
        ...
        int g = argb >>> 8 & 0xFF;
        int b = argb & 0xFF;
        BoxRenderUtil.draw_cube_line(INSTANCE.getBuffer(), x, y, z, 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }

    public static void draw_cube_line(BlockPos blockPos, int r, int g, int b, int a, String sides) {
        BoxRenderUtil.draw_cube_line(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1.0f, 1.0f, 1.0f, r, g, b, a, sides);
    }
