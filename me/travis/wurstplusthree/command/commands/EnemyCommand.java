    ...
    public void execute(String[] message) {
        ...
        if (message.length == 1) {
            if (message[0].equalsIgnoreCase("list")) {
                if (WurstplusThree.ENEMY_MANAGER.hasEnemies()) {
                    ClientMessage.sendMessage((Object)ChatFormatting.BOLD + "Listing enemies");
        ...
        switch (word1) {
            case "add": {
                ...
                ClientMessage.sendMessage((Object)ChatFormatting.GREEN + word2 + (Object)ChatFormatting.RESET + " is now your enemy");
                break;
            }
            case "del": {
                WurstplusThree.ENEMY_MANAGER.removeEnemy(word2);
                ClientMessage.sendMessage((Object)ChatFormatting.RED + word2 + (Object)ChatFormatting.RESET + " is no longer your enemy");
                if (word2 != null) break;
                ClientMessage.sendErrorMessage("need name");
                return;
            }
